...
testable requirements. Version-15 source and canonical documentation implement
...
| `CHR-COPY-COMPAT-001` | Advance generator compatibility when generated authored bytes change. | Baseline `MAINTENANCE.md` and `GENERATION-COHERENCE.md` / 3 | Final generator diff | `app/scenario-generator.ts`, save tests/docs | At the version-14 boundary, version-13 saves failed closed unless a separately specified reconstruction path existed. | Same seed silently yields new authored pack under v13 or prior save is guessed/coerced. | **Implemented at the historical version-14 boundary; superseded for current source by `CHR-COPY-COMPAT-002`**; historical v13 remains preserved. |
| `CHR-COPY-COMPAT-002` | Advance compatibility again when the in-world Summary correction changes generated authored pack bytes. | Pre-commit authored-pack byte audit and `GENERATION-COHERENCE.md` / 1, 3 | `CHR-COPY-COMPAT-001`, final in-world Summary generator diff | Generator, save model, fixtures, docs, and evidence | Current generator is version 15; version-13 and version-14 saves fail closed unless a separately specified reconstruction path exists, and current evidence is regenerated from version-15 packs. | Keep version 14 after Crossover and signaling-observable bytes change, silently replay a v14 save through v15, or relabel v14 evidence as current. | **Implemented and verified by the final automated working-tree gate**; preserves the failed version-14 pre-commit attempt and its version-15 correction. |
